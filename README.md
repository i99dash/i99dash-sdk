...
The old packages — `@i99dash/sdk-types`, `@i99dash/sdk`, `@i99dash/admin-sdk`, `@i99dash/sdk-cli` — are deprecated. Everything they exported now lives in `i99dash`. See [MIGRATING.md](./MIGRATING.md) for the sed snippets.
